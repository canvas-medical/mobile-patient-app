...
export type { Appointment, AppointmentCreationData, AppointmentCancellationData } from '@interfaces/appointment';
...
export type { LabReport, LabImagingReport, DiagnosticReport } from '@interfaces/lab-results';
